...
<body>
  ...
  <div class="container-fluid">
    <a class="navbar-brand ms-5 " href="#">SkillUps</a>
    ...
    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
      <div class="navbar-nav ">
        <ul class="navbar-nav custom-nav  ms-5 ">
          <li class="nav intem custom-nav-item me-3"> <a href="index.php" class= "nav-link">Home </a> </li>
          <li class="nav intem custom-nav-item me-3"> <a href="#services" class= "nav-link">Services </a> </li>
          <li class="nav intem custom-nav-item me-3"> <a href="#aboutUs" class= "nav-link">About Us </a> </li>
          <?php
          session_start();
          ...
          ?>
          <li class="nav intem custom-nav-item me-3"> <a href="#FeedBack" class= "nav-link">Feedback </a> </li> 
          <li class="nav intem custom-nav-item me-5"> <a href="#ContactUs" class= "nav-link">Contact </a> </li>
        </ul>
        <form class="d-flex">
